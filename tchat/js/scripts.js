        ...
        if (this.readyState == 4){
            if(this.status == 200){
                ...
                for(let message of messages){
                    ...
                    discussion.insertAdjacentHTML('beforeend', `<p>${message.pseudo} a écrit le ${dateMessage.toLocaleString()} : ${message.message}</p>`)
                    let objDiv = document.getElementById("discussion"); objDiv.scrollTop = objDiv.scrollHeight;
